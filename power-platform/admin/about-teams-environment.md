...
Every team in Microsoft Teams is linked 1:1 to a [Microsoft 365 group](https://docs.microsoft.com/microsoft-365/admin/create-groups/office-365-groups?view=o365-worldwide).
...
|Unit  |Service limit  |
|---------|---------|
|Dataverse for Teams environments      | 5 + 1 per 20 eligible office seats for first 200,000 eligible seats.* <br /> *Customers with more than 200,000 office seats should contact their Microsoft representative. <br />   |
|Max Dataverse for Teams environment storage per tenant      | 10 GB + Dataverse for Teams environments &times; 2 GB (up to a maximum of 19.5 TB). <br /> This 2GB storage limit per Dataverse for Teams environment can't be extended further. Should more storage be needed, consider upgrading environments to Dataverse.  |
